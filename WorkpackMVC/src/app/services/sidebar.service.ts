  ...
  getMenus(pageParams): Observable<SidebarMenu[]> | Observable<String> {
    ...
    const sidebarMenu: {
      ...
      },
      {
        ...
        'routerLink': '/companySettingsManagement',
        'ParentModuleID': 1,
        'URL': '',
        'AnchorClass': '',
        'CountClass': '',
      ...
      },
      {
        // tslint:disable-next-line:max-line-length
        'ModuleID': 5,
        'ModuleName': 'Communication settings management',
        'routerLink': '/communicationSettingsManagement',
        'ParentModuleID': 1,
        'URL': '',
        'AnchorClass': '',
        'CountClass': '',
      ...
      },
      {
        // tslint:disable-next-line:max-line-length
        'ModuleID': 6,
        'ModuleName': 'Miscellaneous management',
        'routerLink': '/miscellaneousManagement',
        'ParentModuleID': 1,
        'URL': '',
        'AnchorClass': '',
        'CountClass': '',
      ...
      },
      {
        // tslint:disable-next-line:max-line-length
        'ModuleID': 7,
        'ModuleName': 'Standard Repository',
        'routerLink': '/stdRepository',
        'ParentModuleID': 1,
        'URL': '',
        'AnchorClass': '',
        'CountClass': '',
